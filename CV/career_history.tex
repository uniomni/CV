...
\begin{itemize}
  ...
  \item Development of InaSAFE - a software tool that can model impact from natural hazards to infrastructure and population. InaSAFE was developed for Indonesia but is used more broadly. InaSAFE won the Black Duck prize for most promising projects of 2012. % \url{http://www.blackducksoftware.com/news/releases/black-duck-announces-2012-open-source-rookies-year-winners}
